...
export const SETTINGS_GROUPS: SettingsGroup[] = [
  ...
  // ─── ⚙ CRM CONFIG ───────────────────────────────────
  {
    ...
    items: [
      ...
      // Phase Wave 2 welcome-probe 2026-05-29 — tin chào mừng sau khi gửi lời mời kết bạn
      { id: 'welcome-message', label: 'Tin nhắn chào mừng', icon: '💌', route: '/settings/marketing/welcome-message', permission: 'admin', aliases: ['welcome', 'chào mừng', 'tin chào', 'probe', 'người lạ', 'stranger', 'auto greeting'] },
